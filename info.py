...
BOT_TOKEN = environ.get('BOT_TOKEN', '7639880195:AAEq3LBG3P_CRfxWvC0efnUWbMZOwcdgTV0')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002607443878'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+y6wh94tWJMFhNTVl')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002638741965').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://moviesbhai22103:moviesbhai22103@basant.yabbdwz.mongodb.net/?retryWrites=true&w=majority&appName=Basant")
DATABASE_NAME = environ.get('DATABASE_NAME', "Basant")
